...
let
  ...
  shared = config.my.sharedSecrets or {
    enable = false;
    file = null;
  };
      ...
      type = lib.types.attrsOf (lib.types.submodule {
        options = {
          ...
          usernameSecret = lib.mkOption {
            type = lib.types.str;
            description =
              "Name of the SOPS secret containing this profile's OpenVPN username.";
          };

          passwordSecret = lib.mkOption {
            type = lib.types.str;
            description =
              "Name of the SOPS secret containing this profile's OpenVPN password.";
          };
              ...
              vpn =
                {
                  ...
                  user-name =
                    "$OPENVPN_USERNAME_${envName connectionName}";
